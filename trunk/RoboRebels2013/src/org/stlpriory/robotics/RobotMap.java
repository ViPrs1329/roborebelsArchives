...
public class RobotMap {
    ...
    public static final int LEFT_FRONT_DRIVE_MOTOR_CAN_BUS_ADDRESS  = 12;  // DEV channel
    public static final int LEFT_REAR_DRIVE_MOTOR_CAN_BUS_ADDRESS   = 11;  // PWM channel
    public static final int RIGHT_FRONT_DRIVE_MOTOR_CAN_BUS_ADDRESS = 13;  // PWM channel
    public static final int RIGHT_REAR_DRIVE_MOTOR_CAN_BUS_ADDRESS  = 14;  // PWM channel

    // Loader and shooter speed controllers mappings to PWM channels on the digital sidecar module
    public static final int LOADER_MOTOR_PWM_CHANNEL = 8;	         // PWM channel TODO: Change
