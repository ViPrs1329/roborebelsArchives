 ...
 *
 * 1: Left Stick X Axis -Left:Negative ; Right: Positive 2: Left Stick Y Axis -Up: Negative ; Down: Positive 3: Triggers
 * -Left: Positive ; Right: Negative 4: Right Stick X Axis -Left: Negative ; Right: Positive 5: Right Stick Y Axis -Up:
...
//        super(port, numAxisTypes, numButtonTypes);
     ...
     *
     * The buttons are returned in a single 16 bit value with one bit representing the state of each button. The
     * appropriate button is returned as a boolean value.
     *
...
//    }
    /**
     * Get the value of the throttle on the joystick where 0 being the bottom and 1 being the top.
     *
